...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update_recipe(self):
        ...
        payload = {'title': 'gheyme', 'tags': [new_tag.id]}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='kabab kubide')
        recipe2 = sample_recipe(user=self.user, title='kabab juje')
        tag1 = sample_tag(user=self.user, name='Gusht')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Ashe dugh')
        recipe2 = sample_recipe(user=self.user, title='Ashe reshte')
        ingredient1 = sample_ingredient(user=self.user, name='Dugh')
        ingredient2 = sample_ingredient(user=self.user, name='Reshte')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Supe morgh')
